            ...
            <div class="box-body pad">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?php if(isset($data)):?>
                        <input type="hidden" class="form-control" name="idproduct" value="<?=$data['idproduct'];?>">
                        <input type="hidden" name="old_image" value="<?=$data['product_image'];?>">
                        <?php endif;?>
                        <label>Nama <span style="color:red;"></span></label>
                        <input type="text" class="form-control" placeholder="ex : Kopi Bubuk" name="product_name"
                            value="<?=isset($data) ? $data['product_name'] : set_value('product_name');?>" autofocus>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="ex : Kopi" name="satuan"
                            value="<?=isset($data) ? $data['satuan'] : set_value('satuan');?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Box Add Post -->
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control harga" placeholder="Harga Beli" name="harga_beli"
                                value="<?=isset($data) ? $data['harga_beli'] : set_value('harga_beli');?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control harga" placeholder="Harga Jual" name="harga_jual"
                                value="<?=isset($data) ? $data['harga_jual'] : set_value('harga_jual');?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control harga" placeholder="Harga Diskon" name="diskon"
                                value="<?=isset($data) ? $data['diskon'] : set_value('diskon');?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control harga" placeholder="Berat Produk" name="berat"
                                value="<?=isset($data) ? $data['berat'] : set_value('berat');?>">
                            <div class="input-group-addon">
                                gram
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control harga" placeholder="Stok Produk" name="stok"
                            value="<?=isset($data) ? $data['stok'] : set_value('stok');?>" <?=$edit_stok;?>>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="editor1" name="keterangan" rows="10"
                            cols="80"><?=isset($data) ? $data['keterangan'] : set_value('keterangan');?></textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <!-- Box Add Post -->
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="image"
                            value="<?=isset($data) ? $data['product_image'] : set_value('image');?>">
