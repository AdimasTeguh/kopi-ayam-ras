...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url(); ?>"><b>Kopi Ayam Ras</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Silahkan masukkan nama dan Password !</p>
            ...
            <form action="<?=base_url('auth/register');?>" method="post">
                ...
                <button type="submit" class="btn btn-primary btn-block btn-flat mb-5">Daftar sini</button>
            </form>

            <!-- <a href="#">I forgot my password ?</a><br> -->
            Udah Punya akun ?<a href="<?=base_url('auth');?>" class="text-center"> Login sini</a>
            <br>
