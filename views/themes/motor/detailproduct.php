<div class="hero-wrap hero-bread"
    style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/Quando Os Grãos.jpeg');">
    <div class="container">
...
<section class="ftco-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate" style="height:400px;">
                ...
                <a href="<?=base_url().'uploads/products/'.$img->image;?>" class="image-popup"><img
                        ...
                        style="border:1px solid;margin-bottom:5px;width:460px;height:460px;"></a>
                <?php endforeach;?>
            </div>
