...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/kopi1.jpeg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kopi Ayam Ras</h1>
            <h2 class="subheading mb-4">Kopi Terbaik Jambi</h2>
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/dashboard.jpeg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Biji Kopi dengan kualitas terbaik</h1>
            <h2 class="subheading mb-4">Kopi Asli Jambi</h2>
                ...
                <div class="row">
                    <div class="col-md-4 align-items-stretch d-flex">
                        <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                            style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/dashboard3.jpeg);">
                            <div class="text text-center">
                                <h2>Tips Membuat Kopi Ala Ayam Ras</h2>
                                <p>Pilih Sesuai Selera</p>
                                <p><a href="<?=base_url('public/category');?>" class="btn btn-primary">Tips
                                        Membuat</a></p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <p>Berikut ini testimoni pelanggan yang sudah berbelanja di Ayam Ras.</p>
            </div>
        </div>
