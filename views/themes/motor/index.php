...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url() ?>/uploads/logo.JPG" />
</head>
...
<body class="goto-here">
                    ...
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <a href="tel:<?=settings('company_profile','phone');?>"><span
                                    class="text">0812334466</span></a>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                                    class="icon-paper-plane"></span></div>
                            <a href="mailto:<?=settings('company_profile','email');?>"><span
                                    class="text">kopiayamras@gmail.com</span></a>
                        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="#">kopi ayam ras</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?=isset($publiccategory) ? 'active':'';?>"><a
                            href="<?=base_url('public/category');?>" class="nav-link">Tips Pembuatan Kopi</a></li>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2"><a href="#">KOPI AYAM RAS</a></h2>
                        <p>Produk Asli dari Jambi</p>
