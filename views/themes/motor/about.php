    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/kopiindonesia.png);">
                <a href="https://youtu.be/Xxo0G8Fp-sM?si=9RGd8Xr6UBjqazsl"
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Selamat datang di Kopi Ayam Ras</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    <p>Silahkan berbelanja di website Kopi Ayam Ras.</p>
                    <p>Kopi dengan Biji Pilihan.</p>
